...
(function() {
  ...
  jQuery(function() {
    ...
    $('#slider-two').slider({
      ...
      value: 50,
      slide: function(event, ui) {
        return $("#leaning-belief").val(ui.value);
      }
    });
    $('#slider-three').slider({
      min: 0,
      ...
      value: 50,
      slide: function(event, ui) {
        return $("#belief-two").val(ui.value);
      }
    });
    $('#slider-four').slider({
      min: 0,
      ...
      value: 50,
      slide: function(event, ui) {
        return $("#leaning-belief-two").val(ui.value);
      }
    });
    $("#pro-ideas").mouseover(function() {
      return $('html,body').css('cursor', 'pointer');
    });
    $("#pro-ideas").mouseout(function() {
      return $('html,body').css('cursor', 'auto');
    });
    $("#your-pro-ideas").mouseover(function() {
      return $('html,body').css('cursor', 'pointer');
    });
    $("#your-pro-ideas").mouseout(function() {
      return $('html,body').css('cursor', 'auto');
    });
    $("#con-ideas").mouseover(function() {
      return $('html,body').css('cursor', 'pointer');
    });
    $("#con-ideas").mouseout(function() {
      return $('html,body').css('cursor', 'auto');
    });
    $("#your-con-ideas").mouseover(function() {
      return $('html,body').css('cursor', 'pointer');
    });
    return $("#your-con-ideas").mouseout(function() {
      return $('html,body').css('cursor', 'auto');
    });
  });
