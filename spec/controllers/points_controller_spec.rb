  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved point as @point" do
        ...
        post :create, {:point => { "condition" => "invalid value" }}, valid_session
        assigns(:point).should be_a_new(Point)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested point" do
        ...
        Point.any_instance.should_receive(:update).with({ "condition" => "" })
        put :update, {:id => point.to_param, :point => { "condition" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the point as @point" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Point.any_instance.stub(:save).and_return(false)
        put :update, {:id => point.to_param, :point => { "condition" => "invalid value" }}, valid_session
        assigns(:point).should eq(point)
      end
